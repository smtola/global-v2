...
const OrgChart = () => {
  ...
  const [positionKh, setPositionKh] = useState('');
  ...
  const handleSubmit = async () => {
    ...
    const { error: insertError } = await supabase
        ...
        .insert([{ nameEn,nameKh,positionEn,positionKh, image: fileName }]);
  ...
  const editId = async (id) =>{
    ...
    data.map((items) => {
      if (items.id === id) {
        ...
        setPositionEn(items.positionEn);
        setPositionKh(items.positionKh);
                      ...
                      <div className="my-2 col-span-12">
                        ...
                        <div className="flex">
                          ...
                          <textarea
                              ...
                              className="border-b border-gray-300 focus:border-[#314bb2] transition-all duration-500 outline-none focus:outline-none block flex-1 min-w-0 w-full text-md px-4 py-2.5 "
                              placeholder="Set welcome descriptions in English"
                              onChange={(e) => setPositionKh(e.target.value)}
                              required
                          >
                          </textarea>
                        </div>
