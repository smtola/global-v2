    ...
    <>
        ...
        <div className="w-full bg-[#ffffff]">
          ...
          <div className="bg-blue-600 pt-24 pb-32 clip-path-3 z-10">
            <div className="flex justify-center items-center gap-[10vw]">
              ...
              <div>
                <div className="flex gap-[1vw] items-center pb-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="-2 -2 24 24"
                    width="124"
                ...
                <div className="flex gap-[1vw] items-center pt-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="-2 -2 24 24"
                    width="124"
              ...
              <div className="flex justify-center gap-3 my-3">
                <div className="flex justify-center">
                  ...
                  <div className="w-[30vh] p-5 bg-[#182760]">
                    ...
                    <p className="text-[#ffffff] font-['inter']">Your Perfect Business Consultant</p>
                ...
                <div className="flex justify-center">
                  <div className="w-[30vh] overflow-hidden">
                    ...
                    <div className="w-[30vh] p-5 bg-[#CCD8E8]">
                      ...
                      <p className="text-[#182760] font-['inter']">Your Perfect Business Consultant</p>
      ...
      <footer>
        <div className="w-full max-w-screen-xl mx-auto py-5">
          <div>
            <h1 className="text-[30px] text-[#182760] font-['koulen'] my-2">Contact Us</h1>
            <div>
              <ul className="text-[#182760]">
                <li className="flex gap-2 my-2">
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-5 -1.5 24 24" width="28" fill="currentColor"><path d="M7 20.565c-4.667-6.09-7-10.423-7-13a7 7 0 1 1 14 0c0 2.577-2.333 6.91-7 13zm0-9a4 4 0 1 0 0-8 4 4 0 0 0 0 8z"></path></svg>
                  </span>
                  <span>KT Tower (9th Floor, Room 906), St. 112, Psar Depo III, Toul Kork, Phnom Penh, Cambodia.</span>
                </li>
                <li className="flex gap-2 my-2">
                  <span>
                ...
                <span>info@global-consultancy.biz
        ...
        <div className="w-full bg-[#182760] p-5">
            <h1 className="text-[#eee] text-center text-[20px] font-['inter']">Copyright @ {new Date().getFullYear()}, <b>Global Consultancy</b></h1>
        </div>
      </footer>
    </>
  );
